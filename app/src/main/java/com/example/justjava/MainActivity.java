...
public class MainActivity extends AppCompatActivity {
    ...
    public void submitOrder(View view) {
        ...
        intent.setData(Uri.parse("mailto:dethaaa@gmail.com")); // only email apps should handle this
    ...
    private int calculatePrice(boolean addWhippedCream, boolean addChocolate) {
        ...
        // If the user wants whipped cream, add $10 per cup
        if (addWhippedCream) {
            basePrice = basePrice + 10;
        }

        // If the user wants chocolate, add $15 per cup
        if (addChocolate) {
